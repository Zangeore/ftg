...
SHUTDOWN = io.BytesIO(get("https://github.com/Zangeore/ftg/blob/master/stop.mp3?raw=true")) 
SHOTDOWN.name = "voice.mp3"
STARTUP = io.BytesIO(get("https://github.com/Zangeore/ftg/blob/master/Start.mp3?raw=true")) 
